...
export default function AccommodationExperiencesPage() {
  ...
  const actions = (row: ExperienceItem): ActionItem[] => [
    {
      label: tc("view"),
      onClick: () => router.push(`/dashboard/accommodation/experiences/${row.id}`),
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <DataTable
        ...
        pageSize={10}
        onRowClick={(row) => router.push(`/dashboard/accommodation/experiences/${row.id}`)}
        actions={actions}
        emptyState={{
          ...
          action: {
            ...
            onClick: () => router.push("/dashboard/accommodation/experiences/add"),
          },
        }}
        mobileCardRenderer={(row) => (
          <div className="space-y-2">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href={`/dashboard/accommodation/experiences/${row.id}`}>
