    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <Card className="sm:col-span-1 flex flex-col items-center justify-center py-6">
          ...
          <p className="text-xs text-stone-400">{t("totalReviews", { count: reviews.length })}</p>
          <div className="flex gap-3 mt-2 text-xs">
            <span className="text-emerald-600">{t("replied", { count: repliedCount })}</span>
                      ...
                      {expandedReplies[review.id] && (
                        <div className="mt-2 rounded-lg bg-emerald-50 border border-emerald-100 p-3">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-[10px] text-stone-400">{review.replyDate}</span>
                          </div>
                          <p className="text-sm text-emerald-800">{review.replyText}</p>
                        </div>
                      )}
                    </div>
                  )}
